...
export const PAGE_CODE = 'ALARM_MULTIPLE_STATISTICS_ALARM_PAGE';
...
export const TABLE_COLS = [
  ...
  { title: '预警标题', prop: 'alarmTitle', slotName: 'alarmTitle', minWidth: '16em', showTooltip: true, tooltipProps: { minWidth: '240px' }, fixed: { position: 'left', } },
  { title: '预警等级', prop: 'alarmLevelName', minWidth: '8em' },
  { title: '风险分类', prop: 'eventTypeName', minWidth: '12em', showTooltip: true, tooltipProps: { minWidth: '240px' } },
  { title: '预警开始时间', prop: 'startTime', minWidth: '14em' },
  { title: '预警状态', prop: 'alarmState', slotName: 'alarmState', minWidth: '8em' },
  { title: '研判状态', prop: 'judgeStatusName' },
  { title: '预警来源', prop: 'alarmOriginName' },
