...
import { IgetFindAlarmLogPageSpace } from '@/apis/modules/whole-analysis/alarm-whole-analysis/model';
...
const getListData = async() => {
  ...
  const { data } = await apiAlarmWholeAnalysObj.getFindAlarmLogPage(query as Record<string, any>);
...
const downLoad = async() => {
  ...
  await apiAlarmWholeAnalysObj.postExportList(params);
};
...
const init = async() => {
  ...
  } = await apiAlarmWholeAnalysObj.getFindAlarmLogPageStatistic({
    ...props.modelData,
    ...pagination
  });
