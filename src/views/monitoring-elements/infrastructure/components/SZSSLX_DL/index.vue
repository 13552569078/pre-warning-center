...
import { IpostPageListSpace } from '@/apis/modules/special-facility/facility-road/model';
...
const cols = ref([
  ...
  { title: '道路名称', prop: 'facilityName', minWidth: '200px', showTooltip: true, tooltipProps: { maxWidth: '260px' } },
  { title: '道路类别', prop: 'roadTypeName', minWidth: '200px', showTooltip: true, tooltipProps: { maxWidth: '260px' } },
  ...
  { title: '道路状态', prop: 'facilityStateVal' },
...
const getSearchItems = async() => {
  // 下拉-设施类型
  const result1 = await apiDictObj.getListDictCustomVOsDict('SZSSLX_DL');
  const item1 = {
    type: 'select',
    label: '设施类别',
    placeholder: '请选择设施类别',
