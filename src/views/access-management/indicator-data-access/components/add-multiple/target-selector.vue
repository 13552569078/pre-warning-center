...
const cols = ref([
  ...
  { title: '指标',
    ...
    showTooltip: true,
    tooltipProps: { maxWidth: '340px' }, },
  { title: '数据类型', prop: 'dataTypeName', minWidth: '90px' },
  ...
  { title: '启用时间', prop: 'initCollectTime', fixed: 'right', minWidth: '180px' },
  // { title: '指标分类', prop: 'targetTypeName' },
  // { title: '计算公式', prop: 'formulaName' },
  // { title: '数据对象', prop: 'accessSourceObjectName' },
  // { title: '数据项名称', prop: 'address' },
  // { title: '设备标识', prop: 'address' },
