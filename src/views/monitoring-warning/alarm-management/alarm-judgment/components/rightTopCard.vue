<template>
  <hl-group align gap="var(--lg)" full class="m-b-lg">
    <hl-group :style="`padding: 28px; background: url(${card1}) no-repeat; background-size: cover;`" align="items-left items-middle" class="w-full" gap="var(--xl)">
      ...
      <hl-group align="items-left items-top" dir="vertical" gap="var(--xs)"><span class="text-inverse font-lg font-bold text-inverse">待研判报警</span>
    ...
    <hl-group style="padding: 28px; background: #FFFFFF;" align="items-left items-middle" class="w-full" gap="var(--xl)">
      ...
      <hl-group align="items-left items-top" dir="vertical" gap="var(--xs)"><span class="text-regular font-bold" style="font-size: 16px; line-height: 24px;">一级报警</span>
        <hl-group align="items-left items-top" gap="var(--lg)">
          <hl-group align="items-left items-middle" gap="10px">
    ...
    <hl-group style="padding: 28px; background: #FFFFFF;" align="items-left items-middle" class="w-full" gap="var(--xl)">
      ...
      <hl-group align="items-left items-top" dir="vertical" gap="var(--xs)"><span class="text-regular font-bold" style="font-size: 16px; line-height: 24px;">二级报警</span>
        <hl-group align="items-left items-top" gap="var(--lg)">
          <hl-group align="items-left items-middle" gap="10px">
            <hl-group align="items-left items-middle" gap="10px">
    ...
    <hl-group style="padding: 28px; background: #FFFFFF;" align="items-left items-middle" class="w-full" gap="var(--xl)">
      ...
      <hl-group align="items-left items-top" dir="vertical" gap="var(--xs)"><span class="text-regular font-lg font-bold">三级报警</span>
        <hl-group align="items-left items-top" gap="var(--lg)">
          <hl-group align="items-left items-middle" gap="10px">
    ...
    <hl-group style="padding: 28px; background: #FFFFFF;" align="items-left items-middle" class="w-full" gap="var(--xl)">
      ...
      <hl-group align="items-left items-top" dir="vertical" gap="var(--xs)"><span class="text-regular font-lg font-bold">四级报警</span>
        <hl-group align="items-left items-top" gap="var(--lg)">
          <hl-group align="items-left items-middle" gap="10px">
...
import { IgetFindUnJudgeStatisticSpace } from '@/apis/modules/ygf-alarm-info/model';

const cards = ref<IgetFindUnJudgeStatisticSpace.Data>({
...
const getData = async() => {
  const { data } = await apiYgfAlarmInfoObj.getFindUnJudgeStatistic();
  cards.value = data;
};
