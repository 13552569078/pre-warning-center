<template show-source>
  <hl-panel
    class="tree-panel static h-full w-xxl"
    body-padding="var(--xl)"
    borderless
    inner-scroll
  >
      ...
      <template #default="{ node, data }">
        ...
        >
          <span
            ...
            :style="`width:${node.level <= 3 ? '160' : '150'}px`"
...
const filterNode = (value: string, data: IgetListEventTreeVOsEventTypeSpace.Data) => {
  ...
  return data.systemCode.indexOf(value) !== -1 || data.eventTypeName.indexOf(value) !== -1;
};
